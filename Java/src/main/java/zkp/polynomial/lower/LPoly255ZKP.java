 ...
 *
 */
public class LPoly255ZKP extends PedersenZKP {
	...
	public LPoly255ZKP(BigInteger x, BigInteger y, int numberOfGs) {
		...
		this.zs.add(m1.add(challenge.multiply(x)));
		this.zs.add(m2.add(challenge.multiply(x2)));
		this.zs.add(m4.add(challenge.multiply(x4)));
		this.zs.add(m8.add(challenge.multiply(x8)));
		this.zs.add(m16.add(challenge.multiply(x16)));
		this.zs.add(m32.add(challenge.multiply(x32)));
		this.zs.add(m64.add(challenge.multiply(x64)));
		this.zs.add(m128.add(challenge.multiply(x128)));

		this.t = rm.add(challenge.multiply(rx)).mod(this.n);
		this.u = rv1.multiply(challenge).add(rv0).mod(this.n);
		this.s = ry.multiply(challenge8).add(rw7.multiply(challenge7)).add(rw6.multiply(challenge6)).add(rw5.multiply(challenge5))
				.add(rw4.multiply(challenge4)).add(rw3.multiply(challenge3)).add(rw2.multiply(challenge2)).add(rw1.multiply(challenge))
				.add(rw0).mod(this.n);
	...
	public boolean verify() {
		...
		Commitment ret3_2 = this.cy.mul(challenge8).add(this.cws.get(7).mul(challenge7)).add(this.cws.get(6).mul(challenge6))
				.add(this.cws.get(5).mul(challenge5)).add(this.cws.get(4).mul(challenge4)).add(this.cws.get(3).mul(challenge3))
				.add(this.cws.get(2).mul(challenge2)).add(this.cws.get(1).mul(challenge)).add(this.cws.get(0));
