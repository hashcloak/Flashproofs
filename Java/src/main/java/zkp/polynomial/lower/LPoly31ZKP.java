 ...
 *
 */
public class LPoly31ZKP extends PedersenZKP {
	...
	public LPoly31ZKP(BigInteger x, BigInteger y, int numberOfGs) {
		...
		this.s = ry.multiply(challenge5).add(rw4.multiply(challenge4)).add(rw3.multiply(challenge3)).add(rw2.multiply(challenge2))
	...
	public boolean verify() {
		...
		Commitment ret3_2 = this.cy.mul(challenge5).add(this.cws.get(4).mul(challenge4)).add(this.cws.get(3).mul(challenge3))
