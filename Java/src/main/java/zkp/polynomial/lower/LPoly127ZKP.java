 ...
 *
 */
public class LPoly127ZKP extends PedersenZKP {
	...
	public LPoly127ZKP(BigInteger x, BigInteger y, int numberOfGs) {
		...
		this.s = ry.multiply(challenge7).add(rw6.multiply(challenge6)).add(rw5.multiply(challenge5)).add(rw4.multiply(challenge4))
				.add(rw3.multiply(challenge3)).add(rw2.multiply(challenge2)).add(rw1.multiply(challenge)).add(rw0).mod(this.n);
	...
	public boolean verify() {
		...
		Commitment ret3_2 = this.cy.mul(challenge7).add(this.cws.get(6).mul(challenge6)).add(this.cws.get(5).mul(challenge5))
				.add(this.cws.get(4).mul(challenge4)).add(this.cws.get(3).mul(challenge3)).add(this.cws.get(2).mul(challenge2))
